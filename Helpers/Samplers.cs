...
namespace PathTracer
{
    public static class Samplers
    {
        public static Vector3 UniformSampleSphere()
        {
            ...
            //double u = ThreadSafeRandom.NextDouble();
            //double v = ThreadSafeRandom.NextDouble();

            double theta = ThreadSafeRandom.NextDouble() * 2 * Math.PI;
            double phi = Math.Acos(1 - ThreadSafeRandom.NextDouble() * 2);
            //double u = ThreadSafeRandom.NextDouble();
