...
namespace PathTracer
{
  public class Scene
  {
    ...
    public static Scene CornellBox()
    {
      ...
      s.Elements.Add(new DiffuseAreaLight(new Sphere(80, true, Transform.Translate(278, 548, 280).A(Transform.RotateX(90))), Spectrum.Create(1), 20));
      //s.Elements.Add(new DiffuseAreaLight(new Sphere(1600, false, Transform.Translate(278, 274.4, 280).A(Transform.RotateX(90))), Spectrum.Create(1), 20));
      ...
      el = new Sphere(100, true, Transform.Translate(139, 100, 419.4));
      //el.BSDF.Add(new OrenNayar(Spectrum.ZeroSpectrum.FromRGB(Color.Blue), 5));
      el.BSDF.Add(new Lambertian(Spectrum.ZeroSpectrum.FromRGB(Color.Blue)));
      s.Elements.Add(el);

      el = new Sphere(100, true, Transform.Translate(417, 100, 419.4));
      //el.BSDF.Add(new OrenNayar(Spectrum.ZeroSpectrum.FromRGB(Color.Blue), 500));
      el.BSDF.Add(new Lambertian(Spectrum.ZeroSpectrum.FromRGB(Color.Blue)));
      s.Elements.Add(el);

      //el = new Sphere(100, true, Transform.Translate(400, 100, 230));
